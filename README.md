...
### Observational Lab Reports
Lab reports based on observational work conducted using the **Stone Edge Observatory** telescope.

### Python Notebooks
- Homework assignments I found particularly engaging.
- An **independent research project** focused on building a **Generative Adversarial Network (GAN)** in PyTorch, capable of generating realistic fake images of galaxies from scratch.
...
Thanks for visiting!
Feel free to explore the folders and reach out if you have feedback or collaboration ideas.
